...
# 5 подарунків розподіляються протягом приблизно 1200 прокруток:
#
# 1-й подарунок — 180-та прокрутка
# 2-й подарунок — 420-та прокрутка
...
PRIZE_POOL_VERSION = os.getenv(
    "PRIZE_POOL_VERSION",
    "five-new-prizes-1200-participants-v1",
)
